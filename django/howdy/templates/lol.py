...
features_label1 = extract_features1('output.wav')
...
reconstructed_model = tensorflow.keras.models.load_model("cnnspeakerRecog2_lab3.h5")

preds = reconstructed_model.predict_classes(X)
